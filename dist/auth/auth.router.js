...
router.post("/get-otp", auth_controller_1.AuthController.createOTP);
...
router.put("/update-password", verifyLogin_1.VerifyLogin, auth_controller_1.AuthController.updatePassword);
