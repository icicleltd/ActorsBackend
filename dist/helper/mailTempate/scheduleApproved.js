...
const scheduleApprovedTemplate = (name, dates, message, memberName) => {
    ...
    const formatDates = (dates) => {
        if (!dates || dates.length === 0)
            return "N/A";
        return dates
            .map((date) => new Date(date).toLocaleString("en-US", {
            weekday: "short",
            year: "numeric",
            month: "long",
            day: "numeric",
...
`,
      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 24px;">
        ...
        dates && dates.length > 0
            ? dates
                .map((date) => `<div style="margin-bottom: 4px;">• ${new Date(date).toLocaleString("en-US", {
                weekday: "short",
                year: "numeric",
                month: "long",
                day: "numeric",
