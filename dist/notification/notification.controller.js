...
const read = (0, catchAsync_1.default)(async (req, res, next) => {
    ...
    const { type, recipient, application, schedule, payment, contact, isRead, notifyPayment, ticket } = req.body;
    if (role === "member" &&
    ...
    const result = await notification_services_1.NotificationService.read(role, recipient, schedule, contact, notifyPayment, payment, ticket, application, isRead, notificationId, type);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
        message: "updated successfully",
