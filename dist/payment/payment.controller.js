...
const createBeAMember = (0, catchAsync_1.default)(async (req, res, next) => {
    ...
    const result = await payment_services_1.BeAMemberService.createBeAMember(PayloadBeAMember);
...
const getBeAMembers = (0, catchAsync_1.default)(async (req, res, next) => {
    const result = await payment_services_1.BeAMemberService.getBeAMembers();
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const deleteBeAMember = (0, catchAsync_1.default)(async (req, res, next) => {
    const { id } = req.params;
    const result = await payment_services_1.BeAMemberService.deleteBeAMember(id);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
